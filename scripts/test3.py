...
output_dir = r"C:/Users/lalit/OneDrive/Desktop/Csv_QB/output"
...
def ocr_invoice_to_csv(input_path, output_csv_path):
    ...
    if input_path.lower().endswith(".pdf"):  
        images = convert_from_path(
            input_path,
            poppler_path=r"C:\Users\lalit\Downloads\Release-24.08.0-0\poppler-24.08.0\Library\bin"
        )
    else:
...
#CSV_PATH = os.path.join(output_dir, "SampleData(Sheet1).csv")  # Path to your CSV with all invoice rows
CSV_PATH = os.path.join("C:/Users/lalit/OneDrive/Desktop/Csv_QB/input_files", "SampleData(Sheet1).csv")
...
def watchdog(input_path, csv_path=CSV_PATH, processed_bols_path=None):
    temp_ocr_csv = os.path.join(output_dir, "temp_ocr.csv")
    if processed_bols_path is None:
        processed_bols_path = os.path.join(output_dir, "processed_bols.txt")
    df = ocr_invoice_to_csv(input_path, temp_ocr_csv)
    ...
    xml_file = os.path.join(output_dir, f"xml_{bol_number}.xml")
    ...
    if not rows.empty:
        ...
        print(qbxml)
        qbxml_file = os.path.join(output_dir, f"qbxml_{bol_number}.xml")
...
if __name__ == "__main__":
    folder = r"C:\Users\lalit\OneDrive\Desktop\Csv_QB\input_files"
